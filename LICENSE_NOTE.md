...
- **YCOE** (Old English): Oxford Text Archive license â€” no redistribution.
...
- **HeliPaD** (Old Saxon): CC BY-NC-SA â€” processed derivatives shared here
  non-commercially with attribution, same license.
- **IcePaHC** (Old Icelandic): LGPL â€” processed derivatives shared here.
- **Project Wulfila** (Gothic): research use â€” processed derivatives shared
  for research replication; contact the project before further reuse.
- **Referenzkorpus Altdeutsch** (OHG): CC BY-NC-SA (via LAUDATIO) â€” processed
